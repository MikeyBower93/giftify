defmodule GiftifyWeb.Router do
  use GiftifyWeb, :router

  import GiftifyWeb.UserAuth
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: GiftifyWeb.Telemetry
    end
  end
